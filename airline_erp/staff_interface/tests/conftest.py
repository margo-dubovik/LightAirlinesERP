...
@pytest.fixture
def testsupervisor(db, django_user_model):
    email = 'test_staff_member1@test.com'
    password = 'strong-test-pass1!'
    first_name = 'staff_first_name'
    last_name = 'staff_last_name'
    staffuser = django_user_model.objects.create_user(id=1, email=email, password=password, first_name=first_name,
                                                      last_name=last_name, is_airline_staff=True)
    return staffuser


@pytest.fixture
def testgatemanager(db, django_user_model):
    email = 'test_staff_member2@test.com'
    password = 'strong-test-pass1!'
    first_name = 'staff_first_name'
    last_name = 'staff_last_name'
...
@pytest.fixture
def testcheckinmanager(db, django_user_model):
    email = 'test_staff_member3@test.com'
    password = 'strong-test-pass1!'
    first_name = 'staff_first_name'
    last_name = 'staff_last_name'
    staffuser = django_user_model.objects.create_user(id=3, email=email, password=password, first_name=first_name,
                                                      last_name=last_name, is_airline_staff=True)
    return staffuser


@pytest.fixture
def testsupervisorprofile(db, django_user_model, testsupervisor, airport_LGA):
    supervisor = StaffProfile.objects.create(user=testsupervisor, airport=airport_LGA, role='supervisor')
    return supervisor

@pytest.fixture
def testgatemanagerprofile(db, django_user_model, testgatemanager, airport_LGA):
    gate_manager = StaffProfile.objects.create(user=testgatemanager, airport=airport_LGA, role='gate_manager')
    return gate_manager

@pytest.fixture
def testcheckinmanagerprofile(db, django_user_model, testcheckinmanager, airport_LGA):
    gate_manager = StaffProfile.objects.create(user=testcheckinmanager, airport=airport_LGA, role='checkin_manager')
    return gate_manager
